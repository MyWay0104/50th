...
- Naver 기사·Streamlit 최종 실습 HTML과 ZIP 판본. 실습 안내판(S08/S13/S19/S20/S26/S32/S37)의 단계 이름을 실제 HTML 장 이름과 맞춰야 한다.
...
- 16:00–16:20 휴식을 별도로 둘지. 두면 자유 실습이 70분이 되고 S41–S43 시각을 조정한다.
