# HyperFrames v2 Card News Template
...
- topic 경로: `C:\LSW_Coding\3_slide_master_v2\topics\_card_news_template`
...
```powershell
python scripts\validate_topic.py topics\_card_news_template
npx hyperframes lint topics\_card_news_template
```
